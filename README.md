...
1. Plug and play code configuration
---
...
2. Automatic construction of class hierarchies
---
...
4. Namespacing is implicit in your class hierarchies
---
...
Under Construction.
 ...
 - What should be a configurable?
 - I've my code a number of times, and I need to add a new parameter. How do I ensure my new configurations are compatible with older ones?
 - What if my class already has a base class?
 - I already have a class hierarchy, can I use scooch without rewriting it?
 - I use my constructors for things other than configuration, but scooch expects the constructor to be a single Config argument. Can I still use scooch?
    - (Note arguments that may be non-configurable, e.g., data based arguments.
    - Augment constructors, use class methods, or SetData methods...
 - My code doesn't use class's, it's a script, or series of functions, how do I use Scooch?
